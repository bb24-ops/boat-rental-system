 ...
 * @author boris
 */
public class PromeniAdministratoraSO extends ApstraktnaGenerickaOperacija {

    @Override
    protected void preduslovi(Object objekat) throws Exception {
        if (objekat == null || !(objekat instanceof Administrator)) {
            throw new Exception("Sistem ne može da promeni administratora: neispravan objekat.");
        }
        ...
        // provera telefona da sadrži samo cifre i 6-15 cifara
